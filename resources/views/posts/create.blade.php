...
@section('content')
    ...
    <form action="{{route('posts.store')}}" method="POST" class="bg-white shadow rounded p-4 flex flex-col">
        ...
        <input type="number" name="category_id" id="category_id" class="border-2 border-gray-200 p-2">
